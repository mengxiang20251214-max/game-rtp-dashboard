...
function DataRow({ label, value, pct, isGold, isWeak }: DataRowProps) {
  const fillStyle = isWeak
    ...
    : {
        ...
        boxShadow: "0 0 10px rgba(63,208,201,0.40)",
      };
    ...
    <div>
      <div className="mb-1.5 flex items-baseline justify-between gap-2">
        ...
        <span
          ...
          style={{ color: isGold ? "#f2c14e" : "#3fd0c9" }}
        >
          {value}
        </span>
      </div>
        ...
        <div className="flex gap-3">
          ...
          >
            {game.image && !imgError ? (
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, #0c2233, #0d3a35)" }}
              >
                <span
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center gap-1">
            ...
            <span
              ...
              style={{ letterSpacing: "0.20em", color: "#3fd0c9" }}
            >
