          ...
          <button
            ...
            style={{
              ...
              borderColor: isActive
                ? "rgba(61,140,255,0.55)"
                : "rgba(174,184,208,0.14)",
              background: isActive
                ? "rgba(61,140,255,0.12)"
                : "transparent",
              color: isActive ? "#3d8cff" : "#8b96b4",
              boxShadow: isActive
                ? "0 0 16px rgba(61,140,255,0.18)"
                : "none",
            }}
          >
            {/* 发光圆点（选中态） */}
            {isActive && (
              <motion.span
                ...
                style={{ background: "#3d8cff", boxShadow: "0 0 6px rgba(61,140,255,0.80)" }}
            ...
            <span
              ...
              style={{
                background: isActive ? "rgba(61,140,255,0.18)" : "rgba(174,184,208,0.08)",
                color: isActive ? "#3d8cff" : "#5d6b91",
              }}
            >
              {counts[opt.value] ?? 0}
            </span>
