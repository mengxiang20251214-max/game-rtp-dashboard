    ...
    <header className="border-b border-border-subtle/14">
      <div className="relative mx-auto max-w-7xl px-4 py-5 sm:px-6">
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2 sm:right-6">
            ...
            {onRefresh && (
              <button
                ...
                style={{
                  borderColor: "rgba(55,182,255,0.40)",
                  background: "rgba(55,182,255,0.08)",
                  color: "#37b6ff",
                  letterSpacing: "0.10em",
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(55,182,255,0.15)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(55,182,255,0.08)";
                }}
              >
                <svg
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 22px rgba(55,182,255,0.45), inset 0 1px 0 rgba(255,255,255,0.20)",
              }}
            >
              <span
          ...
          >
            <span style={{ color: "#37b6ff" }}>AI</span>
