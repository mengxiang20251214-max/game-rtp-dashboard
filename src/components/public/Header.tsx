    ...
    <header className="border-b border-border-subtle/14">
      <div className="relative mx-auto max-w-7xl px-4 py-5 sm:px-6">
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2 sm:right-6">
            ...
            {onRefresh && (
              <button
                ...
                style={{
                  borderColor: "rgba(61,140,255,0.40)",
                  background: "rgba(61,140,255,0.08)",
                  color: "#3d8cff",
                  letterSpacing: "0.10em",
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(61,140,255,0.15)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.background = "rgba(61,140,255,0.08)";
                }}
              >
                <svg
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <div
              ...
              style={{
                width: "42px",
                height: "42px",
                background: "linear-gradient(150deg, #3d8cff 0%, #0f2c6e 100%)",
                boxShadow:
                  "0 0 22px rgba(61,140,255,0.45), inset 0 1px 0 rgba(255,255,255,0.20)",
              }}
            >
              <span
            ...
            >
              X<span style={{ color: "#3d8cff" }}>168</span>
            </h1>
          </motion.div>
          ...
          >
            <span style={{ color: "#3d8cff" }}>AI</span>
